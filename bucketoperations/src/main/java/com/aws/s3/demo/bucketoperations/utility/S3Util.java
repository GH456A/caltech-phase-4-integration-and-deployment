...
public class S3Util {
	...
	public static List<Bucket> listBucketsInS3() {
		...
		try {
			...
			System.out.println("Current Buckets Size: " + bucketList.size());
			bucketList.forEach((bucket) -> System.out.println(bucket.getName()));		
		} catch (Exception e) {
			System.out.println("Exception occured during listing of S3 buckets: " + e);
		}
		return bucketList;
	}
	...
	public static void createBucketInS3(String bucketName) {
		try {
			...
			System.out.println("Exception occured while creating the bucket: " + e);
		}
	}
	...
	public static void deleteEmptyBucketInS3(String bucketName) {
		try {
			...
			System.out.println("Exception while deleting a empty bucket: " + e);
		}
	}
	...
	public static void deleteFilledBucketInS3(String bucketName) {
		try {
			...
			System.out.println("Exception occured while deleting a filled bucket with name: " + bucketName);
		}
	}
}
